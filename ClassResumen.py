...
#-------------------------------------------Generar PDF-------------------------------------------
    ...
    def get_emotion_counts(self):
        ...
        emociones = ['Concentracion', 'Feliz', 'Frustracion', 'Calma', 'Enojado', 'Estresado', 'Neutral']
        self.cursor.execute("SELECT emocion FROM emociones WHERE idSesion = %s", (self.idSesion,))
        emociones2 = self.cursor.fetchall()
        conteos_emociones = {emocion: 0 for emocion in emociones}
...
#------------------------------------ Generar Graficos -------------------------------------------
    ...
    def generate_spider_chart(self):
        ...
        valores_normales = [10, 20, 15, 25, 5, 10, 15]  # Ejemplo de valores normales
    ...
    def generate_heatmap(self):
       ...
       # Frecuencia simulada de emociones en distintos intervalos de tiempo
        ...
        emociones = ['Feliz', 'Frustracion', 'Estresado', 'Enojado', 'Concentracion', 'Neutral']
    ...
    def generate_line_graph(self):
        ...
        emociones_dict = {
            'Estresado': 0, 'Enojado': 1, 'Frustracion': 2, 'Neutral': 3, 'Calma': 4, 'Feliz': 5, 'Concentracion': 6
        }
        ...
        plt.yticks([0, 1, 2, 3, 4, 5, 6], ['Estresado', 'Enojado', 'Frustracion', 'Neutral', 'Calma', 'Feliz', 'Concentracion'])
