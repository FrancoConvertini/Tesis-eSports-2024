...
def abrir_entrenamiento():
    subprocess.Popen(["python", "Entrenamiento.py"])
    window.destroy()
...
def generate_image():
    ...
    new_image = PhotoImage(file=relative_to_assets(r"C:\Users\Nicolas\Documents\GitHub\Tesis-eSports-2024\assets_perfil\image_6.png"))  # Asegúrate de tener esta imagen
    ...
    #Generar botones
    button_image_6 = PhotoImage(file=relative_to_assets(r"C:\Users\Nicolas\Documents\GitHub\Tesis-eSports-2024\assets_perfil\button_5.png"))
